...
__C.DATASET.YOUTUBEBB.NUM_USE = -1#19927#-1  # use all not repeat

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = 'training_dataset/coco/crop511'
__C.DATASET.COCO.ANNO = 'training_dataset/coco/train2017.json'
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1#11726#-1

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = 'training_dataset/det/crop511'
__C.DATASET.DET.ANNO = 'training_dataset/det/train.json'
__C.DATASET.DET.FRAME_RANGE = 1
__C.DATASET.DET.NUM_USE = -1#33347#-1

__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = 'training_dataset/got/crop511'
__C.DATASET.GOT.ANNO = 'training_dataset/got/train.json'
__C.DATASET.GOT.FRAME_RANGE = 100
__C.DATASET.GOT.NUM_USE = 160000#-1#9335
...
__C.DATASET.LASOT.NUM_USE = 160000#-1#1400
...
__C.LATENTS = CN()
# Inner loop option
__C.LATENTS.EXP_NAME = 'latent'
__C.LATENTS.ENCODER_ADJUST = '3-layer'
__C.LATENTS.HP = False
__C.LATENTS.DECODER_DEEP = False
__C.LATENTS.DECODER_WIDE = False
__C.LATENTS.DECODER_BIAS = False
__C.LATENTS.DECODER_NAME = ''
__C.LATENTS.NEW_LABEL = True
