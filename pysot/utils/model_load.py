...
def load_pretrain(model, pretrained_path):
    ...
    try:
        ...
        check_keys(model, pretrained_dict)
    # remove mimatch weights
    if 'resnet101'  in pretrained_path or 'resnet152'  in pretrained_path:
        pretrained_dict.pop('layer2.0.downsample.0.weight', None)
        pretrained_dict.pop('layer3.0.downsample.0.weight', None)
        pretrained_dict.pop('layer4.0.downsample.0.weight', None)
