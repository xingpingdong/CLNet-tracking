...
from toolkit.datasets import OTBDataset, UAVDataset, LaSOTDataset, \
        VOTDataset, NFSDataset, VOTLTDataset, DTBDataset, TempleDataset
...
parser.add_argument('--tracker_path', '-p', default='../hp-codes/all_train_result/LaSOT/latent_pn_new_data_wide', type=str,
                    help='tracker result path')
parser.add_argument('--dataset', '-d', default='LaSOT', type=str,
                    help='dataset name')
parser.add_argument('--num', '-n', default=1, type=int,
                    help='number of thread to eval')
parser.add_argument('--tracker_prefix', '-t', default='0.*',
                    type=str, help='tracker name')
parser.add_argument('--show_video_level', '-s', dest='show_video_level',
                    action='store_true')
parser.add_argument('--cfg', default='../experiments/siamrpn_r50_l234_dwxcorr/config.yaml', type=str,
        help='config file')
...
def main():
    ...
    print('experiment name: ', cfg.LATENTS.EXP_NAME)
    if 'OTB' in args.dataset:
        ...
        benchmark.show_result(success_ret, precision_ret,
                show_video_level=args.show_video_level)
    elif 'Temple-color-128' in args.dataset:
        dataset = TempleDataset(args.dataset, root)
        dataset.set_tracker(tracker_dir, trackers)
        benchmark = OPEBenchmark(dataset)
        success_ret = {}
        with Pool(processes=args.num) as pool:
